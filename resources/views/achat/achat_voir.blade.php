<div class="container pb-5">
    <div class="row">
        <div class="col-lg-5 mt-5">
            <div class="card mb-3">
                <img class="card-img img-fluid" src="{{ asset('storage/' . $produit->photo1) }}" alt="Image du produit" id="product-detail">
            </div>
            <div class="row">
                <!--Start Controls-->
                    ...
                    <div class="carousel-inner product-links-wap" role="listbox">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="{{ asset('storage/' . $produit->photo2) }}" alt="Product Image 1">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="{{ asset('storage/' . $produit->photo3) }}" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="{{ asset('storage/' . $produit->photo4) }}" alt="Product Image 3">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="{{ asset('storage/' . $produit->photo5) }}" alt="Product Image 4">
                                    </a>
                                </div>
                            </div>
                        </div>
